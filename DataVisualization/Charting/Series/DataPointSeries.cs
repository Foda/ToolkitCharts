            ...
            if ((PlotArea != null) && (SeriesHost != null))
            {
                ...
                if (oldItems != null)
                {
                    if (oldItems != null)
                    {
                        ...
                        for (int i = oldItems.FastCount() - 1; i >= 0; i--)
                        {
                            object dataContext = oldItems.FastElementAt<object>(i);
                ...
                if (newItems != null)
                {
                    for (int i = 0; i < newItems.FastCount(); i++)
                    {
                        object dataContext = newItems.FastElementAt<object>(i);
